...
urlpatterns = [
    ...
    path("im-here/administrator/route-sheets/", views.RouteSheetUploadListView.as_view(), name="route_sheet_upload_list"),
    path("im-here/administrator/route-sheets/upload/", views.RouteSheetUploadCreateView.as_view(), name="route_sheet_upload_create"),
    path("im-here/administrator/route-sheets/<int:pk>/", views.RouteSheetUploadDetailView.as_view(), name="route_sheet_upload_detail"),
    path("im-here/administrator/route-sheets/<int:pk>/delete/", views.RouteSheetUploadDeleteView.as_view(), name="route_sheet_upload_delete"),
