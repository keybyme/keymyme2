...
class SchoolsConfig(AppConfig):
    ...
    def ready(self):
        ...
        # LeftRightPhotoUploadView's per-file ImageField validation and
        # for OCR (vault.route_sheet_ocr.extract_text opens the file via
        # PIL.Image.open). Global to the whole process once registered
        # here, not just to this app, but this is the app that actually
        # accepts HEIC uploads (LeftRightPhotoUpload).
